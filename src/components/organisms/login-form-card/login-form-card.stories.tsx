import LoginFormCard, {
    LoginFormCardProps,
    LoginFormType,
} from './login-form-card';
...
export const UsernameAndPasswordDefault: StoryFn<LoginFormCardProps> =
    Template.bind({});
...
export const AuthorizeFromSessionDefault: StoryFn<LoginFormCardProps> =
    Template.bind({});
